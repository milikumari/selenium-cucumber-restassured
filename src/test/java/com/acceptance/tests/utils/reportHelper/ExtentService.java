...
public class ExtentService implements Serializable {
    ...
    public static synchronized ExtentReports getInstance() {
        return com.acceptance.tests.utils.reportHelper.ExtentService.ExtentReportsLoader.INSTANCE;
    }
    ...
    public static String getScreenshotFolderName() {
        return com.acceptance.tests.utils.reportHelper.ExtentService.ExtentReportsLoader.SCREENSHOT_FOLDER_NAME;
    }

    public static String getScreenshotReportRelatvePath() {
        return com.acceptance.tests.utils.reportHelper.ExtentService.ExtentReportsLoader.SCREENSHOT_FOLDER_REPORT_RELATIVE_PATH;
    }

    public static boolean isBase64ImageSrcEnabled() {
        return com.acceptance.tests.utils.reportHelper.ExtentService.ExtentReportsLoader.ENABLE_BASE64_IMAGE_SRC;
    }
    ...
    private static class ExtentReportsLoader {
        ...
        private static void createViaProperties() {
            ...
            ClassLoader loader = com.acceptance.tests.utils.reportHelper.ExtentService.ExtentReportsLoader.class.getClassLoader();
            ...
            if (is.isPresent()) {
                ...
                try {
                    ...
                    com.acceptance.tests.utils.reportHelper.ExtentService.properties = properties;
        ...
        private static void initKlov(Properties properties) {
            ...
            if (configPath != null && !configPath.isEmpty() && f.exists()) {
                ...
                com.acceptance.tests.utils.reportHelper.ExtentService.getInstance().tryResolveMediaPath(new String[] { url });
                try {
